...
public AdminController(ReservationService reservationService, ShiftService shiftService, UserRepository userRepository) {
//フィールドへ予約サービスを設定
...
@RequestParam("endTime") @DateTimeFormat(iso = DateTimeFormat.ISO.TIME) LocalTime endTime) {
	...
	model.addAttribute("reservationCountByMenu", reservationService.getReservationCountByMenu(startDate,
	endDate));
	// スタッフ別の予約件数マップを取得しモデルへ
	model.addAttribute("reservationCountByStaff", reservationService.getReservationCountByStaff(startDate,
	endDate));
