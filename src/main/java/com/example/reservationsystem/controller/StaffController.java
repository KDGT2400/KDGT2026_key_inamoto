...
public class StaffController {
	...
	public StaffController(ReservationService reservationService, ShiftService shiftService, UserRepository
	...
	model.addAttribute("reservation", reservationService.getReservationById(reservationId).orElse(new
	Reservation()));
	// スタッフ一覧も再投入
